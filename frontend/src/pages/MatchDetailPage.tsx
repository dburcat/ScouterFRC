        ...
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="bg-app-card border border-app-border rounded-lg p-5">
            <div className="flex items-center justify-between mb-3">
              <h2 className="text-lg font-medium text-white">Match {matchData.match_number}</h2>
            ...
            {matchData.played_at && (
              <p className="text-[11px] text-slate-600">
                Played: {new Date(matchData.played_at).toLocaleString()}
              </p>
            )}
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            {['red', 'blue'].map(color => {
              const alliance = matchData.alliances.find((a: any) => a.color === color);
                    ...
                    <div className="space-y-3">
                      ...
                      <div>
                        ...
                        <div className="space-y-1">
                          {alliance?.robot_performances?.map((rp: any, i: number) => (
                            <button
                              key={i}
                              onClick={() => {

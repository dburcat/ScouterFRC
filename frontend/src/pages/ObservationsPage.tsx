...
import { ClipboardPen, Plus, Star, Search, AlertCircle, Loader } from 'lucide-react';
              ...
              <table className="w-full text-xs">
                <thead>
                  <tr className="border-b border-app-border bg-app-muted/30">
                    ...
                    <th className="px-4 py-3 text-left font-medium text-slate-400 hidden sm:table-cell">Match</th>
                  ...
                  {filtered.map((obs, idx) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3 text-slate-400 max-w-xs hidden md:table-cell">
                        {obs.notes ? (
                          <span className="truncate block max-w-[200px]">{obs.notes}</span>
                        ) : (
